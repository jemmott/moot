"""
TO DO
Remove video functionality, and refocus this code on only:
1. read distance sensor
2. Exponential smoothing
3. Map distance to mode, theremin frequency, and playback speed
4. Put those params on MQTT
5. Make audio output
6. Update PixelBlaze settings
"""
from audio_input import freq_to_speed
from video_output import display_frame
from utils.color_names import closest_color
from distance import (
    map_distance_to_frequency,
    generate_sine_wave,
    SAMPLE_RATE,
    FRAME_LENGTH,
    MAX_FREQ,
